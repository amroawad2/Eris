        ...
        while(fault_per_file_count != fault_num):
            ...
            if(reg_total[count0] == 1): 
                ...
                if "[" in reg_names[count0]:
                    ...
                    index = randint(1, reg_total[count0])
            ...
            #cycle
            if(cycle != -1): to_write = to_write + ", " + str(randint(0, cycle))
            ...
            if(op_type != '0'):
                #bit = 1
                bit = 1 << randint(0, reg_widths[count0])
                ...
                if(bit <= 0xF):
                    ...
                    else: to_write = to_write + ", 0xF" + hex(bit).lstrip("0x")
                else:
